puzz = """Game 1: 6 green, 3 blue; 3 red, 1 green; 4 green, 3 red, 5 blue
...
Game 100: 5 green, 11 blue, 6 red; 5 green, 12 blue; 1 green, 14 blue, 1 red; 3 blue, 5 red, 6 green; 9 blue; 6 red""".split("\n")

total = 0

for game in puzz:
	id = int(game[4: game.index(":")])
	game = game[game.index(": ") + 2:].split("; ")
	red, green, blue = 0, 0, 0
	for combination in game:
		combination = combination.split(", ")
		for ting in combination:
			num = int(ting[0: ting.index(" ")])
			if "green" in ting: green = max(green, num)
			elif "red" in ting: red = max(red, num)
			elif "blue" in ting: blue = max(blue, num)
